...
exports.getProfessionalById = (req, res) => {
    ...
    sequelize.query("select u.*,t.name  as 'typename' from userprofessionals u inner join types t on u.typeId = t.id  where u.userId ="+req.params.id+" ", { type: sequelize.QueryTypes.SELECT })
    .then((result) => {
      res.json({  "result": result });
    })
    .catch((err) => {
